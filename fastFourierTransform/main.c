...
int main (int argc, const char * argv[])
{
    ...
    for (int i = 0; i < getImageHeight()*numberOfFiles(); i++) {
        ...
        memcpy(Da1R+offset, Da+offset, getImageWidth());
        memcpy(Da1I+offset, Dk+offset, getImageWidth());
